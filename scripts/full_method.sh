...
mount_dir=data
save_dir=data/exps
# pretrained_descriptor_dir="${save_dir}/experiments/off-the-shelf/features/${pretraining}_vit${model}_pretrained_embeddings/descriptors/0/backbone_out_embedd"
pretrained_descriptor_dir="${mount_dir}/features/${pretraining}_vit${model}_pretrained_embeddings/descriptors/0/backbone_out_embedd"
...
echo "Using pretrained train descriptors from ${pretrained_descriptor_dir}"
...
--config.pretrained_train_descriptors_dir="${pretrained_descriptor_dir}" \
...
--config.loss.pretrained_embedding_distill_loss_on="1" \
--config.loss.pretrained_embedding_distill_loss_weight=1000.0 \
--config.loss.pretrained_weights_loss=True \
